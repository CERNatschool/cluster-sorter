...
if __name__ == "__main__":
    ...
    lg.basicConfig(filename='log_make-plots.log', filemode='w', level=level)
    ...
    kp += "    <table>\n"
    kp += "      <caption>Fig. 1: Cluster size.</caption>\n"
    kp += "      <tr><td><img src=\"kls.png\" /></td></tr>\n"
    kp += "    </table>\n"
    kp += "    <table>\n"
    kp += "      <caption>Fig. 2: Total counts per cluster.</caption>\n"
    kp += "      <tr><td><img src=\"klc.png\" /></td></tr>\n"
    kp += "    </table>\n"
    kp += "    <table>\n"
    kp += "      <caption>Fig. 3: Max. count value in the cluster.</caption>\n"
    kp += "      <tr><td><img src=\"klm.png\" /></td></tr>\n"
    kp += "    </table>\n"
    kp += "    <table>\n"
    kp += "      <caption>Fig. 4: Cluster radii.</caption>\n"
    kp += "      <tr><td><img src=\"klr.png\" /></td></tr>\n"
    kp += "    </table>\n"
    kp += "    <table>\n"
    kp += "      <caption>Fig. 5: Cluster density &rho;.</caption>\n"
    kp += "      <tr><td><img src=\"kld.png\" /></td></tr>\n"
    kp += "    </table>\n"
    kp += "    <table>\n"
    kp += "      <caption>Fig. 6: Fraction of inner pixels.</caption>\n"
    kp += "      <tr><td><img src=\"kli.png\" /></td></tr>\n"
    kp += "    </table>\n"
    kp += "    <table>\n"
    kp += "      <caption>Fig. 7: Cluster linearity.</caption>\n"
